    ...
    <div class="card shadow">
      ...
      <div class="card-body">
        ...
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
          <li class="nav-item" role="presentation">
            ...
            href="#confirmed-appointments" role="tab" aria-selected="true">Mis próximas citas</a>
          </li>
          <li class="nav-item" role="presentation">
            <a class="nav-link" data-toggle="pill" href="#pending-confirmed" role="tab" aria-selected="false">Citas por confirmar</a>
          </li>
          <li class="nav-item" role="presentation">
      ...
      <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane fade show active" id="confirmed-appointments" role="tabpanel">
          @include('appointments.tables.confirm')
        </div>
        <div class="tab-pane fade" id="pending-confirmed" role="tabpanel">
